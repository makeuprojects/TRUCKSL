...
function applyObsidiana(filePath) {
  ...
  // let's leave 450 alone or map it to something nice if needed
...
try {
  ...
  // ensure inactive points have proper fill if they were slate
  mapContent = mapContent.replace(/fill-\[#1E293B\]/g, 'fill-[#0d1324]');
  mapContent = mapContent.replace(/fill-\[#0F172A\]/g, 'fill-[#070a13]');
